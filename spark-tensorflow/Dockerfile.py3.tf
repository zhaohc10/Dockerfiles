...
RUN apt-get install -y wget vim unzip python3-dev python3-setuptools supervisor python3.4 python3-pip
...
##############################
RUN apt-get update
RUN apt-get install -y python3-scipy python3-matplotlib python3-pandas
